...
import { importHandler, importArgs } from '../src/intents.js'
...
yargsCmd.usage('Botium Connector Cognigy CLI\n\nUsage: $0 [options]') // eslint-disable-line
  ...
  .command({
    command: 'import',
    describe: 'Downloading Convos and Utterances from Cognigy Agent to Botium',
    builder: (yargs) => {
